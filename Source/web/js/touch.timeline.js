    ...
    (function ($, undefined) {
        $(document).ready(function () {
            ...
            Timeline.prototype.showEvent = function (index) {
                ...
                //this.el.find('.timeline-title').css('margin-left', '0px');
                //this.el.find('.selected-event').removeClass('selected-event');
                //this.events[index].node.addClass('selected-event');

                //this.el.find('.arrow_box').removeClass('arrow_box');
                //this.events[index].node.parent().find('.timeline-title').addClass('arrow_box');

                SlideSlider(parseInt(this.events[index].node.parent().data('value')));
                //this.events[index].node.parent().find('.arrow_box').css('margin-left', this.events[index].node.parent().data('margin'));
